            ...
            {categories.map((category) => {
              ...
              return (
               amount>0 &&  <div className="category-card">
                  <h5>{ category }</h5>
                  <Progress strokeColor='#0B5A89' percent={((amount/totalIncomeTurnover ) * 100).toFixed(0)} />
                </div>
              );
            })}
          </div>
          ...
          <div className="category-analysis">
            ...
            {categories.map((category) => {
              ...
              return (
               amount>0 &&  <div className="category-card">
                  <h5>{category}</h5>
                  <Progress strokeColor='#0B5A89' percent={((amount/totalExpenseTurnover ) * 100).toFixed(0)} />
                </div>
              );
            })}
          </div>
